...
professor1 = {'id': 42, 'name': 'Alexandre Abreu', 'age': 30, 'state_origin': 'Minas Gerais', 'courses': 
['Inteligência Artificial', 'Mineração de Dados', 'Programação para Internet I', 'Programação para Internet II']}


professor2 = {'id': 37, 'name': 'Denilson Barbosa', 'age': 40, 'state_origin': 'Paraná', 'courses': 
['Inteligência Artificial', 'Banco de Dados I', 'Banco de Dados II', 'Programação para Internet I']}


professor3 = dict(id=28, name='Jorge Armino', idade=37)

print("Exercício 3\n")
professor1.update({'latitude':-18.10, 'longitude':-44.38})
print(professor1)
print("\n")

professor2.update({'latitude':-24.89, 'longitude': -51.55})
print(professor2)
print("\n")

professor3.update({'latitude': None, 'longitude': None})
print(professor3)
print("\n")